...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference("Language.count") do
      post languages_url, params: { language: { about: @language.about, code: @language.code, title: @language.title } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { about: @language.about, code: @language.code, title: @language.title } }
