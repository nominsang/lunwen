...
class KeywordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create keyword" do
    assert_difference("Keyword.count") do
      post keywords_url, params: { keyword: { language_id: @keyword.language_id, word: @keyword.word } }
    end
  ...
  test "should update keyword" do
    patch keyword_url(@keyword), params: { keyword: { language_id: @keyword.language_id, word: @keyword.word } }
